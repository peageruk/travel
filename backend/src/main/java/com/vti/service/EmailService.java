...
public class EmailService implements IEmailService {
	...
	public void sendRegistrationUserConfirm(String email) {
		...
		String confirmationUrl = "http://18.142.125.125:8080/api/v1/users/activeUser?token=" + token;
	...
	public void sendResetPassword(String email) {
		...
		String confirmationUrl = "http://18.142.125.125:3000/auth/new-password/" + token;
